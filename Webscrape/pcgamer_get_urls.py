...
# need 2 functions
# one to create all review page URLs
# another to run through all review page URLs to get all review URLs
...
def create_urls():
    ...
    :rtype: [str]
    """
    BASE_URL= 'https://www.pcgamer.com/reviews/archive/'
    year = 2010
    all_archive_links = []
...
def get_all_reviews():
    ...
    with open("C:/Users/nicho/OneDrive/Desktop/pc_gamer_urls.txt", 'w') as f:
